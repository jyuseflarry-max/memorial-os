        ...
        {loading ? (
          ...
          <div className="flex flex-col divide-y divide-gray-800 bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden">
            {conversations.map((conv) => (
              ...
              >
                {/* Avatar */}
                <div className="w-9 h-9 rounded-full bg-coaches-blue/20 border border-coaches-blue/30 flex items-center justify-center shrink-0 mt-0.5">
                  <span className="text-coaches-blue text-sm font-bold">
                ...
                filtered.map((u) => (
                  ...
                  >
                    <div className="w-8 h-8 rounded-full bg-coaches-blue/20 border border-coaches-blue/30 flex items-center justify-center shrink-0">
                      <span className="text-coaches-blue text-xs font-bold">{(u.full_name ?? "?").charAt(0).toUpperCase()}</span>
                    </div>
                    <div>
