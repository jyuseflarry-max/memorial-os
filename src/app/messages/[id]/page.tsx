      ...
      <div className="max-w-lg mx-auto flex flex-col h-[calc(100vh-8rem)] md:h-[calc(100vh-6rem)]">
                  ...
                  return (
                    <div key={msg.id} className={`flex flex-col ${isMe ? "items-end" : "items-start"} mb-1`}>
                      ...
                      <div className={`max-w-[80%] px-3.5 py-2 rounded-2xl text-sm leading-snug ${
                        isMe
                          ? "bg-coaches-blue text-white rounded-br-sm"
        ...
        <div className="mt-3 flex items-end gap-2 bg-gray-900 border border-gray-800 rounded-2xl p-2">
          ...
          <button
            ...
            className="p-2.5 rounded-xl bg-coaches-blue hover:bg-coaches-blue-dark disabled:opacity-40 text-white transition-colors shrink-0"
          >
            <Send size={16} />
          </button>
        </div>
