    ...
    >
      ...
      >
        ...
        <textarea
          ...
          className="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 text-sm text-white placeholder-gray-600 font-mono focus:outline-none focus:border-coaches-red transition-colors resize-none"
        />

        {/* Preview count */}
        <div className="flex items-center justify-between text-xs font-mono">
          <span className={preview.length > 0 ? "text-coaches-red" : "text-gray-600"}>
            {preview.length > 0
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex-1 py-2.5 rounded-lg bg-coaches-red hover:bg-coaches-red-dark disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-semibold transition-colors"
          >
